...
export default function Header() {
  ...
  const isLightMode = pathname === "/about" || pathname === "/services" || pathname === "/works" || pathname.startsWith("/services/");
  ...
  return (
    <header className={`site-header ${isScrolled ? "scrolled" : ""} ${isLightMode ? "light-theme" : ""} ${pathname === "/about" ? "about-theme" : ""} ${pathname === "/services" ? "services-theme" : ""} ${pathname === "/industry" ? "industry-theme" : ""}`}>
