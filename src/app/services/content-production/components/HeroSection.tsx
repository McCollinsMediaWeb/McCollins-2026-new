    ...
    <section className={styles.heroSection} ref={containerRef}>
      <div className={styles.heroHeader}>
        <h1 className={styles.heroTitle}>
          <div style={{ overflow: "hidden", display: "inline-block", marginRight: "0.25em", flexShrink: 0 }}>
            <span className={`${styles.heroTitlePlayfair} hero-title-word`} style={{ display: "inline-block" }}>Content</span>
          </div>
          <div style={{ overflow: "hidden", display: "inline-block", flexShrink: 0 }}>
            <span className={`${styles.heroTitleStrong} hero-title-word`} style={{ display: "inline-block" }}>PRODUCTION</span>
          </div>
        </h1>
      </div>
      ...
      <div className={styles.heroSubtitleContainer}>
        <p className={`${styles.heroSubtitle} hero-subtitle`}>
          Driving sustainable growth through data-driven automation engineered for global consistency and local relevance.
        </p>
      </div>
